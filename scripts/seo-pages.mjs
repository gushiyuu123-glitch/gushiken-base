...
const pages = [
  {
    path: "/",
    title: "GUSHIKEN DESIGN｜沖縄のWebデザイン・ホームページ制作",
    description:
    ...
    label: "GUSHIKEN DESIGN / OKINAWA / ONLINE",
    h1: "選ばれる入口を、空気から設計する。",
    lead:
      "GUSHIKEN DESIGNは、沖縄を拠点にLP制作・ホームページ制作・Webデザインを行う個人制作スタジオです。美容室・飲食店・ブライダル・観光体験・タトゥースタジオなど、世界観や体験価値が大切な業種に向けて、見た人の記憶に残り、予約・問い合わせのきっかけになるWebサイトを制作します。",
    points: [
      "LP制作・ホームページ制作・Webデザインに対応。目的に合わせて必要な内容と進め方を整理します。",
      "美容室・飲食店・ブライダル・観光体験・タトゥースタジオなど、世界観や体験価値が大切な業種向け。",
      "写真・言葉・流れを整え、初めて見る人が相談しやすい入口をつくります。",
    ],
    note:
      "何度も見たくなるサイトをつくる。一度見て終わらないWebへ。見た目の印象だけでなく、相談や問い合わせまで自然に進める状態を目指します。",
    links: [
      ["制作実績を見る", "/works"],
      ["お客様の声を見る", "/#voice"],
      ["制作者について", "/about"],
    ...
    faq: [
      [
        ...
        "はい。沖縄県内の店舗・サロン・個人事業主さまを想定したホームページ制作・LP制作の相談に対応しています。",
      ],
      [
        "全国からオンラインで依頼できますか？",
        "はい。沖縄県外からのご相談にもオンラインで対応しています。ヒアリング、確認、公開前チェックまでオンラインで進行できます。",
      ],
      [
        "写真や文章がまだ揃っていなくても相談できますか？",
        "相談できます。必要な写真・文章・掲載情報を整理し、足りない部分は優先順位を決めながら進めます。",
      ],
      [
        "どんな業種のホームページ制作が得意ですか？",
        "美容室・飲食店・ブライダル・観光体験・タトゥースタジオ・アパレルなど、世界観や体験価値が大切な業種と相性が良いです。",
      ],
    ],
    jsonLd: webPageJsonLd({
      path: "/",
      name: "GUSHIKEN DESIGN｜沖縄のWebデザイン・ホームページ制作",
      description:
        "GUSHIKEN DESIGNは、沖縄を拠点にLP制作・ホームページ制作・Webデザインを行う個人制作スタジオです。",
      breadcrumb: [["ホーム", "/"]],
    }),
  },

  {
    ...
    h1: "制作実績",
    lead:
      "GUSHIKEN DESIGNの制作事例一覧です。ブライダル・美容・飲食・観光体験・アパレル・タトゥースタジオなど、世界観や体験価値が大切な業種に向けたWebデザインをまとめています。",
    points: [
      "Vow in Light、KOU RYUI、BLACK PAPILLONなど、世界観を重視した制作事例を掲載しています。",
      "見た目だけでなく、相談や問い合わせのきっかけにつながる流れも大切にしています。",
      "沖縄県内の事業者さま、全国オンラインでの制作相談に対応しています。",
    ],
    note:
      "制作事例は、単なる見た目の一覧ではなく、業種ごとの空気感・見せ方・相談までの流れを確認できる入口として整理しています。",
    links: [
      ["相談する", "/contact"],
      ["料金を見る", "/price"],
      ["制作者について", "/about"],
    ...
    jsonLd: webPageJsonLd({
      ...
      description:
        "GUSHIKEN DESIGNの制作事例一覧。世界観や体験価値が大切な業種に向けたWebデザイン事例を掲載しています。",
      breadcrumb: [
        ["ホーム", "/"],
        ["制作実績", "/works"],
      ],
...

  {
    ...
    points: [
      ...
      "印象重視のWebサイトは240,000円〜。世界観・写真・言葉・相談までの流れを整えます。",
    ],
    note:
...

  {
    ...
    description:
      "GUSHIKEN DESIGNへのホームページ制作・LP制作・Webデザインのご相談はこちら。写真や文章、予算、公開時期がまだ曖昧な段階でも相談できます。沖縄県内・全国オンライン対応。",
    label: "CONTACT / WEB DESIGN CONSULTATION",
    h1: "制作相談・お問い合わせ",
    lead:
      "ホームページ制作、LP制作、Webデザインのご相談はこちらから。写真や文章、予算、公開時期がまだ曖昧な段階でも相談できます。",
    points: [
      "目的・予算・公開時期が未定でも相談できます。",
      "現在のサイトやSNSを見ながら、必要な内容と進め方を整理できます。",
      "美容室・飲食店・ブライダル・タトゥースタジオ・観光体験・アパレルなど、世界観や体験価値が大切な業種に対応しています。",
    ],
    note:
      "まずは、作りたいもの・今困っていること・見せたい印象を共有してください。今ある情報をもとに、必要な内容と進め方を一緒に整理します。",
    links: [
      ["制作実績を見る", "/works"],
      ["料金を見る", "/price"],
      ["制作者について", "/about"],
...

  {
    ...
    h1: "制作者について",
    lead:
      "GUSHIKEN DESIGNの制作者ページです。制作者の背景、Web制作への考え方、制作事例、資格・学習領域などをまとめています。",
    points: [
      "見た目だけでなく、初めて見る人が内容を理解し、相談前の不安を減らせるWebサイトを目指しています。",
      "制作事例では、業種ごとの見せ方・言葉の量・相談までの流れを試しています。",
      "資格や学習領域も掲載し、感覚だけに頼らない制作の土台を積み上げています。",
    ],
    note:
      "GUSHIKEN DESIGNでは、事業の魅力を無理に大きく見せるのではなく、その店やサービスが本来持っている良さを、初めての人にも伝わる形に整えていきます。",
    links: [
      ["制作実績を見る", "/works"],
      ["料金を見る", "/price"],
      ["沖縄向け制作", "/okinawa"],
...

  {
    ...
    lead:
      "沖縄県内の店舗・サロン・個人事業主向けに、予約・問い合わせのきっかけになるホームページ制作・LP制作を行っています。写真・言葉・流れを伝わる順番に整え、初めて見る人が迷わず相談できる入口をつくります。",
    points: [
      "浦添を拠点に、那覇・宜野湾・北谷・沖縄市など沖縄本島内の事業者さまを想定しています。",
      "美容室・理容室・飲食店・カフェ・バー・サロン・観光体験など、世界観や体験価値が大切な業種に対応します。",
      "予約・問い合わせ・来店につながる内容整理、デザイン、公開まで対応します。",
    ],
    note:
    ...
    faq: [
      ...
      [
        "沖縄の店舗サイトでは何が大事ですか？",
        "店の雰囲気、料金、場所、駐車場、予約方法、安心材料がすぐ分かることです。特にスマホで見た時に、初めての人が迷わず問い合わせできる流れが重要です。",
      ],
    ],
    links: [
      ["沖縄で相談する", "/contact"],
...

  {
    ...
    points: [
      ...
      "LP制作、小規模サイト、スマホ対応、SEO/AEOを意識した情報整理まで対応します。",
    ],
    note:
      "オンライン制作で大切なのは、ただ連絡手段を用意することではありません。画面越しでも、事業の背景、空気感、強み、伝えたい印象を読み取り、文字・写真・流れへ変えていきます。",
    faq: [
      [
  ...
  {
    path: "/sketchbook",
    title: "SKETCHBOOK｜GUSHIKEN DESIGN｜沖縄のWebデザイン・ホームページ制作",
    description:
      "GUSHIKEN DESIGNのSketchbook。Webデザインやホームページ制作の途中で残ったラフ、スケッチ、構図メモなどを置いていくページです。",
    label: "SKETCHBOOK / ROUGH / DESIGN NOTE",
    h1: "Sketchbook",
    lead:
      "Webデザインやホームページ制作の途中で残ったラフ、スケッチ、構図メモなどを置いていくページです。完成前の考え方や、画面になる前の手がかりを記録しています。",
    points: [
      "制作前のラフ、構図メモ、見せ方の検討を残しています。",
      "完成した作品だけでは見えにくい、考え方の途中を置いています。",
      "GUSHIKEN DESIGNの制作の裏側を軽く見られるページです。",
    ],
    note:
      "Sketchbookは、完成品としての実績ではなく、制作途中の考え方や視点を残すための場所です。",
    links: [
      ["制作実績を見る", "/works"],
      ["制作者について", "/about"],
      ["相談する", "/contact"],
    ...
    jsonLd: webPageJsonLd({
      path: "/sketchbook",
      name: "Sketchbook｜GUSHIKEN DESIGN",
      description:
        "GUSHIKEN DESIGNのSketchbook。制作途中のラフ、スケッチ、構図メモなどを置いていくページです。",
      breadcrumb: [
        ["ホーム", "/"],
...

  {
    ...
    points: [
      ...
      "プランや相談方法を整理し、比較検討中のユーザーが問い合わせ前で止まらない流れにしています。",
      "スマホで見た時に、雰囲気から相談まで流れが切れないようにしています。",
    ],
    note:
      "ブライダルやフォトウェディングでは、写真そのものが大きな判断材料になります。サイトの余白、文字量、フォント、情報の順番が整っていないと、せっかくの写真が安く見えることがあります。",
    faq: [
      [
      ...
      [
        "高級感や上質さを出すには何が重要ですか？",
        "写真そのものだけでなく、余白、文字量、フォント、スマホで見たときの情報密度が重要です。",
      ],
    ],
    links: [
...

  {
    ...
    faq: [
      [
        ...
        "はい。体験内容、料金、所要時間、持ち物、アクセス、予約までの流れを整理したWebサイト制作に対応できます。",
      ],
      [
        "観光客向けのページでは何が大事ですか？",
      ...
      [
        "スマホ対応は重要ですか？",
        "重要です。観光中のユーザーはスマホで確認することが多いため、スマホでの読みやすさと予約までの流れが大切です。",
      ],
    ],
    links: [
...

  {
    ...
    points: [
      ...
      "黒の世界観を保ちながら、読める余白・行間・流れに整えています。",
    ],
    note:
    ...
    faq: [
      [
        ...
        "はい。施術スタイル、料金目安、予約の流れ、注意点、アフターケアまで整理したWebサイト制作に対応できます。",
      ],
      [
        "Instagramだけでは足りませんか？",
      ...
      [
        ...
        "できます。余白、文字量、背景とのコントラスト、情報の置き方を整えることで、重さではなく世界観として見せられます。",
      ],
    ],
    links: [
...

  {
    ...
    description:
      "GUSHIKEN DESIGNの更新情報。制作実績、Webデザイン、サイト改善、作品の背景などを掲載しています。",
    label: "NEWS / UPDATE / DESIGN LOG",
    h1: "NEWS",
    lead:
      "GUSHIKEN DESIGNの更新情報です。制作実績、Webデザイン、サイト改善、作品の背景などを記録しています。",
    points: [
      "実案件の制作実績や公開情報を掲載します。",
      "作品の背景や制作で考えたことを短く残しています。",
...
function getImageType(image = "") {
  const clean = String(image).split("?")[0].split("#")[0].toLowerCase();
  ...
  return {
    ...
    "@graph": [
      ...
      ]),
      {
        ...
        description:
          "沖縄県内の店舗・サロン・個人事業主向けに、予約・問い合わせのきっかけになるホームページ制作・LP制作・Webデザインを行います。",
      },
  ...
  return {
    ...
    "@graph": [
      ...
      ]),
      {
        ...
        serviceType: "ホームページ制作・LP制作・Webデザイン・SEO/AEOを意識した情報整理",
        provider: {
          "@id": `${SITE_ORIGIN}/#organization`,
        },
        areaServed: {
