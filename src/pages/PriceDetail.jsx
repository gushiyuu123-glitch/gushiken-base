...
const PLANS = [
  {
    ...
    note: "※ ページ追加・撮影・長文ライティングは別途ご相談ください。",
  },
  {
    badge: "02",
    title: "Small Website",
...
const ADDONS = [
  {
    title: "多言語ミニ対応",
    price: "1言語 20,000円",
    desc: "英語・中国語・韓国語に対応。料金・アクセス・予約方法・FAQなど、外国人のお客様が確認したい基本情報を整理します。",
    badge: "LANG",
  },
  {
    title: "運用サポート",
    price: "任意 / 月額 9,800円",
    desc: "必要な方のみ。軽微な更新・NEWS追加など、公開後の小さな運用をサポートします。",
    badge: "CARE",
  },
];
      ...
      <div className="pd-container">
        ...
        <section className="pd-section pd-reveal" aria-label="追加オプション">
          ...
          <p className="pd-footnote">
            多言語対応は基本情報の範囲を超える場合、事前に内容を確認してお見積りします。
            必要な範囲だけ、無理なく追加できます。
          </p>
        </section>
