      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "沖縄の光や海の透明感、果実の色から着想を得て制作したジェラートブランドのコンセプトサイト。爽やかさとやわらかな余韻が自然に伝わることを大切にした作品。",
            creator: {
              "@type": "Person",
              name: "裕人 具志堅",
        ...
        <div className="hidden md:block w-full h-[92vh] relative">
          ...
          <div className="absolute bottom-[17vh] left-[clamp(28px,7vw,120px)] max-w-[720px]">
            ...
            <p className="mt-7 text-[#6faecb] text-[1.06rem] leading-[2.2] max-w-[46ch]">
              沖縄の光は、派手ではなく、
              <br />
              透明で、静かで、最後に爽やかな余韻だけが残る。
              <br />
              その印象を、ジェラートブランドとして形にしました。
            </p>
...
海の透明感、果実の色、やわらかな風。
OkiLato は “味”だけでなく、
その場の爽やかさや余韻まで感じられるようにまとめたブランドサイトです。`}
          </span>

          <span className="block md:hidden">
            光が満ちる、島のジェラート。<br /><br />
            海の透明感、果実の色、やわらかな風。<br />
            OkiLato は “味”だけでなく、<br />
            その場の爽やかさや余韻まで感じられるようにまとめたブランドサイトです。
          </span>
        </p>
        ...
        <div className="mt-14 grid md:grid-cols-12 gap-10 md:gap-12">
          <div className="md:col-span-7">
            ...
            <ul className="space-y-4 text-black/75 text-[0.98rem] md:text-[1.02rem] leading-[2.05]">
              <li>・淡いトーンで、光のやわらかさが伝わること</li>
              <li>・透明感のある見え方で、爽やかさが残ること</li>
              <li>・情報を増やしすぎず、静かに見られること</li>
              <li>・フレーバー写真の魅力が自然に伝わること</li>
            </ul>
          </div>
          ...
          <div className="md:col-span-5">
            ...
            >
              ...
              <p className="mt-4 text-black/75 text-[0.95rem] leading-[2.05] font-light">
                ...
                light, sea transparency, and fruit freshness.
              </p>

              <p className="mt-6 text-black/45 text-[0.82rem] tracking-[0.14em]">
                Keywords: Okinawa / Gelato / Minimal Brand / Aqua & Fruit / Clean Impression
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 text-[#6faecb] text-[0.82rem] leading-relaxed">
          <p>Tech — 軽量で安定した構成 / 見やすさを大切にしたレイアウト</p>
        </div>
