...
家具ブランドのコンセプトサイト。
  ...
  家具ブランドのための<br />構成設計
    ...
    北欧の空間づくりにならい、家具を主役として扱わず、<br />
部屋全体の雰囲気の中で自然に感じられるように構成しています。<br />
見た目の美しさよりも、<br />
「この空間で過ごす心地よさ」が想像できることを最優先にしました。
...
余白と配置を<br />自然に感じられる設計

</h3>


      <p className="mt-5 text-[13px] leading-[2.05] text-[#2b2621]/90">
家具そのものより、置き方や余白で生まれる心地よさが<br />
自然に伝わるように、あえて写真や情報量をしぼっています。<br /><br />
スクロールしても落ち着いて見られるよう、<br />
色味や明るさの差を控えめに整え、全体がやわらかく馴染むよう調整しています。
