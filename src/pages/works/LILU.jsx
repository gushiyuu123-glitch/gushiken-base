        ...
        <div className="bg-white border-t border-neutral-200">
          <div className="max-w-[1120px] mx-auto px-12 py-28">
            ...
            <div className="grid grid-cols-3 gap-12">
              {[
                ["VISUAL", "第一印象で“可愛い”と感じられる写真の見せ方"],
                ["PACE", "ゆったりとした流れで、落ち着いて見られること"],
                ["RELIEF", "予約前にも安心感が残るやわらかな雰囲気"],
              ].map(([t, d]) => (
                <div
                  key={t}
                  className="lilu-fade border border-neutral-200 bg-[#fff7f9] p-10"
                >
                  <p className="text-[12px] tracking-[0.20em] mb-4">{t}</p>
                  <p className="text-[14px] leading-[2.3] text-neutral-600">
                    {d}
                  </p>
                </div>
              ))}
          ...
          <div className="px-6 py-24">
            ...
            <div className="space-y-10">
              {[
                ...
                >
                  <p className="text-[11px] tracking-[0.22em] mb-3">{t}</p>
