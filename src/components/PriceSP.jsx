...
const PLANS = [
  ...
  },
  {
    ...
    price: "¥120,000〜",
    desc:
      "トップページと下層ページで、お店やサービスの情報を伝えるプランです。初めて見る人が迷わず理解できる構成にします。",
    includes: [
      "トップ + 下層2〜4ページ",
      "サービス内容の構成",
      "スマホ対応",
  ...
  },
  {
    ...
    price: "¥240,000〜",
    desc:
      "写真・色・余白・言葉・導線までトーンを合わせ、見た瞬間の印象から相談までつなげるプランです。世界観で選ばれたい方へ。",
    includes: [
      "世界観設計",
      "複数ページ対応",
      "写真 / 色 / 余白のトーン設計",
...
export default function PriceSP() {
  ...
  return (
    <section
      ...
      aria-labelledby="price-sp-title"
    >
      <div className={styles.container}>
        ...
        <header
          ...
          style={{ "--d": "40ms" }}
        >
          <h2 id="price-sp-title" className={styles.srOnly}>
            料金プラン
          </h2>
        ...
        <div className={styles.intro}>
          ...
          >
            ...
            まずは、何を見せるべきか。
            <br />
            <strong>印象の方向</strong>と
            <strong>必要なページと、</strong>伝わる順序から決めていきます。
          </p>
